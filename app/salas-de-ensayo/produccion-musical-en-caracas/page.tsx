...
const canonicalPath = '/salas-de-ensayo/produccion-musical-en-caracas'
const canonicalUrl = `https://www.turpialsound.com${canonicalPath}`
const heroImage = 'https://www.turpialsound.com/images/produccion2.jpg'

const faqItems = [
  {
    question: '¿Dónde puedo producir una canción en Caracas?',
    answer:
      'En Turpial Sound puedes solicitar producción musical en Caracas y trabajar el desarrollo completo de tu canción.',
  },
  {
    question: '¿Qué incluye la producción musical?',
    answer:
      'Incluye enfoque creativo, estructura, sonido, arreglo y acompañamiento técnico para convertir una idea en un tema sólido.',
  },
  {
    question: '¿La producción musical incluye grabación?',
    answer:
      'Puede integrarse según el proyecto. La solicitud se define desde reservas para elegir la modalidad adecuada.',
  },
  {
    question: '¿Puedo llegar con una idea incompleta?',
    answer:
      'Sí. Puedes llegar con una maqueta o idea base y trabajarla con dirección musical para terminarla mejor.',
  },
  {
    question: '¿Cómo reservo una sesión de producción?',
    answer: 'Desde /reservas puedes iniciar la solicitud y especificar el objetivo de tu canción.',
  },
  {
    question: '¿Turpial puede ayudarme a definir el sonido del proyecto?',
    answer:
      'Sí. El servicio de producción musical se enfoca en dirección de sonido y decisiones artísticas del tema.',
  },
]
...
export const metadata: Metadata = {
  ...
  description:
    'Producción musical en Caracas para desarrollar estructura, arreglo y sonido de tu canción en Turpial Sound.',
  alternates: {
    canonical: canonicalUrl,
  },
  openGraph: {
    title: 'Producción musical en Caracas | Turpial Sound',
    description:
      'Producción musical en Caracas para llevar tu canción más lejos con Turpial Sound.',
    url: canonicalUrl,
...
export default function ProduccionMusicalEnCaracasPage() {
    ...
    '@graph': [
      {
        ...
        name: 'Producción musical en Caracas',
        serviceType: 'Producción musical',
        description:
          'Servicio de producción musical en Caracas para estructura, dirección sonora y desarrollo de canciones.',
      ...
      },
      {
        ...
        url: heroImage,
        caption: 'Producción musical en Turpial Sound, Caracas',
      },
      {
        '@type': 'FAQPage',
        '@id': `${canonicalUrl}#faq`,
      ...
      },
      {
        ...
        itemListElement: [
          ...
          { '@type': 'ListItem', position: 3, name: 'Producción musical en Caracas', item: canonicalUrl },
        ],
      },
    ],
  }
        ...
        <article className="space-y-8 text-white/90">
          <header className="space-y-4">
            ...
            <h1 className="text-3xl font-semibold leading-tight text-white md:text-5xl">
              Producción musical en Caracas para llevar tu canción más lejos
            </h1>
            <div className="overflow-hidden rounded-2xl border border-white/10">
              <img src="/images/produccion2.jpg" alt="Producción musical en Turpial Sound" className="h-64 w-full object-cover md:h-80" />
            </div>
          </header>
          ...
          <section className="rounded-2xl border border-accent-gold/30 bg-accent-gold/10 p-6">
            ...
            <p className="mt-3 text-sm leading-relaxed text-white/85 md:text-base">
              Si buscas producción musical en Caracas, Turpial Sound te ayuda a transformar una idea
              en una canción con dirección creativa, estructura y decisiones de sonido. Desde /reservas
              puedes solicitar la sesión y definir lo que necesitas trabajar en tu proyecto.
            </p>
          ...
          <section className="rounded-2xl border border-white/10 bg-white/5 p-6">
            ...
            <dl className="mt-4 grid gap-3 text-sm text-white/85 md:grid-cols-2">
              <div><dt className="font-semibold text-white">Servicio:</dt><dd>Producción musical en Caracas</dd></div>
              ...
              <div><dt className="font-semibold text-white">Ideal para:</dt><dd>Artistas y productores con canciones en desarrollo</dd></div>
              <div><dt className="font-semibold text-white">Qué se puede reservar:</dt><dd>Sesión de producción musical por tema</dd></div>
              ...
              <div><dt className="font-semibold text-white">Servicios relacionados:</dt><dd>/produccion-musical, /salas-de-ensayo</dd></div>
            </dl>
          </section>
          ...
          <section className="rounded-2xl border border-white/10 bg-white/5 p-6">
            ...
            <div className="mt-4 flex flex-wrap gap-3 text-sm">
              ...
              <Link href="/produccion-musical" className="rounded-full border border-white/15 px-4 py-2 text-accent-gold hover:opacity-80">Ver producción musical</Link>
            </div>
          </section>
