    ...
    <div className="space-y-6">
        ...
        {EXTRA_OPTIONS.map((opt) => {
          ...
          return (
            <button
              ...
              className={cn(
                'flex w-full items-start gap-4 rounded-lg border p-4 text-left transition-colors duration-200',
                isChecked
            ...
            >
              ...
              <span className="flex flex-col">
                ...
                <span className="mt-0.5 text-xs text-text-secondary">{opt.description}</span>
              </span>
            </button>
          )
        })}
      ...
      <div>
        ...
        <textarea
          ...
          className={cn(
            'w-full resize-none rounded-lg border bg-brand-surface px-4 py-2.5 text-sm text-text-primary placeholder:text-text-muted outline-none transition-colors',
