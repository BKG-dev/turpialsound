...
No se cierra ningun sprint por intuicion: debe tener rama, commit, push, validacion proporcional, QA minimo, severidad de fallos y handoff.
...
- confirmar preview si aplica;
- confirmar tipo de QA;
- confirmar owner;
- confirmar que NO es produccion;
- confirmar scope y no incluido.
...
No mezclar roles en una misma sesion.

## 3. Severidad PASS / FAIL
...
Se ejecuta cuando algo se mergea a la rama madre.
...
## 5. Flujo canonico buyer/seller/admin
...
## 12. Criterio para cerrar sprint
