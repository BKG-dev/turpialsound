...
async function main(): Promise<void> {
  ...
  try {
    ...
    await insertBookingRequest(client, {
      ...
      status: 'under_review',
      internalNotes: '[ops_status:pending_payment]',
      holdAcquiredAt: new Date('2026-06-22T15:45:00.000Z'),
      holdExpiresAt: dueOneExpiresAt,
      bookingMode: 'custom_bundle',
      pricingSource: 'server_catalog_v1',
      estimatedTotal: 280,
    ...
    await insertBookingRequest(client, {
      ...
      status: 'under_review',
      internalNotes: '[ops_status:pending_payment]',
      holdAcquiredAt: new Date('2026-06-22T15:40:00.000Z'),
      holdExpiresAt: dueOneExpiresAt,
      bookingMode: 'custom_bundle',
      pricingSource: 'server_catalog_v1',
      estimatedTotal: 280,
    ...
    await insertBookingRequest(client, {
      ...
      status: 'under_review',
      internalNotes: '[ops_status:pending_payment]',
      holdAcquiredAt: new Date('2026-06-22T15:41:00.000Z'),
      holdExpiresAt: dueTwoExpiresAt,
      bookingMode: 'custom_bundle',
      pricingSource: 'server_catalog_v1',
      estimatedTotal: 280,
    ...
    await insertBookingRequest(client, {
      ...
      status: 'under_review',
      internalNotes: '[ops_status:pending_payment]',
      holdAcquiredAt: new Date('2026-06-22T15:20:00.000Z'),
      holdExpiresAt: dueOneExpiresAt,
      bookingMode: 'custom_bundle',
      pricingSource: 'server_catalog_v1',
      estimatedTotal: 280,
