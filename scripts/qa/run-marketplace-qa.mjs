...
const MODULES = [
  ...
  { id: 'QA-04', name: 'Purchase Initiation', path: './modules/qa-04-purchase.mjs', layer: 'B', aliases: ['qa-04', 'qa04', 'purchase', 'qa_purchase_initiation'] },
  { id: 'QA-05', name: 'Payment Report', path: './modules/qa-05-payment.mjs', layer: 'B', aliases: ['qa-05', 'qa05', 'payment', 'qa_payment_report'] },
